...
npm install --save-dev jest jsdom jest-environment-jsdom @testing-library/jest-dom @testing-library/dom playwright
...
if npm list playwright --depth=0 &> /dev/null; then
    echo -e "${GREEN}Playwright successfully installed!${NC}"
else
