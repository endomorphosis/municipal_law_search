...
async def search_sse_response(
    ...
    async def _event_generator():
        try:
            ...
            async for result in _search(q=q, page=page, per_page=per_page):
...
class SearchFunction:
    ...
    def __init__(self, search_query: str = None, llm: LLM = None, resources: dict[str, Callable] = None, configs: Configs = None):
        """
        ...
        self.class_connection:       SqlConnection = None   
        self.class_cursor:           SqlCursor     = None
    ...
    def get_data_from_sql(self, cursor: SqlCursor, return_a: str = 'dict', sql_query: str = None, how_many: int = None) -> list[dict[str, Any]]:
        """
...
async def _search(
    ...
    Example:
        ...
        ```
    """
    async with SearchFunction(search_query=q, llm=llm, resources=resources, configs=configs) as search_func:
